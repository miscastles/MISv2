...
namespace MIS
{
    public partial class frmPendingFSRGenerator : Form
    {
        ...
        private void frmPendingFSRGenerator_Load(object sender, EventArgs e)
        {
            ...
            btnOpenManualFSR.Enabled = false;
        ...
        private void btnSearchNow_Click(object sender, EventArgs e)
        {
            ...
            dbAPI.FillListViewFSRList(lvwList);
        ...
        private void lvwList_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (lvwList.Items.Count > 0)
            {
                ...
                pFSRNo = dbFunction.GetSearchValue("FSRNo");
                pServiceNo = dbFunction.GetSearchValue("ServiceNo");
                pIRIDNo = dbFunction.GetSearchValue("IRIDNo");
                pDiagnostic = dbFunction.GetSearchValue("Diagnostic?");
                pMerchantSign = dbFunction.GetSearchValue("Signed?");
                ...
                txtDiagnostic.Text = pDiagnostic;
                txtMerchantSign.Text = pMerchantSign;
                txtMerchRep.Text = dbAPI.GetValueFromJSONString(rtbJSONFormat.Text, clsDefines.TAG_MerchantRepresentative);
                ...
                txtBillable.Text = dbFunction.setIntegerToYesNoString(int.Parse(dbAPI.GetValueFromJSONString(rtbJSONFormat.Text, clsDefines.TAG_isBillable)));

                btnOpenManualFSR.Enabled = true;

            }
        }

        private void frmPendingFSRGenerator_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
        ...
        private void btnOpenManualFSR_Click(object sender, EventArgs e)
        {
            ...
            if (!dbFunction.fPromptConfirmation("Selected merchant information to Manual FSR Window" + "\n\n" +
                    ...
                    " > Merchant Representative :" + txtMerchRep.Text + "\n" +
                    " > Field Engineer :" + txtVendorRep.Text + "\n" +
                    " > Dispatcher :" + txtDispatcher.Text + "\n" +
                    " > Signed? :" + txtMerchantSign.Text + "\n" +
