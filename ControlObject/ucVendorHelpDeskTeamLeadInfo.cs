...
{
    public partial class ucVendorHelpDeskTeamLeadInfo : UserControl
    {
        // Classes
        ...
        public ucVendorHelpDeskTeamLeadInfo()
        {
            InitializeComponent();
        ...
        public void loadData(HelpDeskController model)
        {
            ...
            ParticularController data = _mParticularController.getInfo(model.TeamLeadID);
